...
class CoawaitExpr : public CoroutineSuspendExpr {
  ...
  /// compiler.
  unsigned IsImplicitlyCreated : 1;
public:
  CoawaitExpr(SourceLocation CoawaitLoc, Expr *Operand, Expr *Ready,
              Expr *Suspend, Expr *Resume, bool IsImplicit)
      : CoroutineSuspendExpr(CoawaitExprClass, CoawaitLoc, Operand, Ready,
                             Suspend, Resume), IsImplicitlyCreated(IsImplicit) {}
  ...
  void setIsImplicitlyCreated(bool value = true) { IsImplicitlyCreated = value; }
