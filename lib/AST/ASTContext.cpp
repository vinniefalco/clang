...
BuiltinTemplateDecl *ASTContext::getInvocationTypeDecl() const {
  if (!InvocationTypeDecl)
    InvocationTypeDecl =
        buildBuiltinTemplateDecl(BTK__invocation_type, getInvocationTypeName());
  return InvocationTypeDecl;
}
